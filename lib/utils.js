...
function HSVtoRGB(h, s, v) {
	...
	var r_check = Math.round(r * 255);
	var g_check = Math.round(g * 255);
	var b_check = Math.round(b * 255);

	if(r_check > 255){ r_check = 255;}
	if(g_check > 255){ g_check = 255;}
	if(b_check > 255){ b_check = 255;}

	if(r_check < 0){ r_check = 0;}
	if(g_check < 0){ g_check = 0;}
	if(b_check < 0){ b_check = 0;}
